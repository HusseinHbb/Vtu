                ...
                <View>
                    <View className="py-3 px-4 ">
                        <Text className="font-extrabold text-3xl text-[#f3f2f2] ">
                            Login to your Paypulse account
                        </Text>
                        <View className="py-6 ">
                            <View className="space-y-2">
                                <View>
                                    <Text className="font-bold text-gray-400 text-lg">Enter email</Text>

                                    <View className="bg-[#252525] rounded-xl px-4 py-3 flex-row items-center justify-between space-x-4 my-0.5">
                                        <TextInput
                            ...
                            <TouchableOpacity onPress={handleSignin} className="w-full  py-3 rounded-lg bg-[#6e47b1] my-3 flex items-center justify-center">
                                <Text className=" text-[#f3f2f2] text-lg font-bold">Sign in</Text>
                            </TouchableOpacity>
                            ...
                            <View className="w-full  py-1 flex-row  items-center justify-center space-x-2">
                                <Text className="text-[#f3f2f2]  text-base">Don't have an account !</Text>
                                <TouchableOpacity onPress={() => navigation.navigate("Signup")}>
                                    <Text Text className="text-base font-bold text-[#f3f2f2] " > Create here </Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
